...
type ListServiceLogsRequest struct {
	...
	// Opaque older-page cursor from a previous ListServiceLogsResponse.
	// Empty starts with the newest lines in the requested time range.
	PageToken string `protobuf:"bytes,9,opt,name=page_token,json=pageToken,proto3" json:"page_token,omitempty"`
	// Opaque older-page cursor from ListServiceLogsResponse.next_gap_page_token.
	// Empty starts with the newest gaps in the requested time range.
