...
func (x *DesiredVolume) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
func (x *DesiredService) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
func (x *DesiredService) GetDesiredRevision() int64 {
	if x != nil {
...
type ServiceCondition struct {
	...
	AllocationId    string                 `protobuf:"bytes,1,opt,name=allocation_id,json=allocationId,proto3" json:"allocation_id,omitempty"`
	ServiceId       string                 `protobuf:"bytes,2,opt,name=service_id,json=serviceId,proto3" json:"service_id,omitempty"`
	DesiredRevision int64                  `protobuf:"varint,3,opt,name=desired_revision,json=desiredRevision,proto3" json:"desired_revision,omitempty"`
...
func (x *ServiceCondition) GetDesiredRevision() int64 {
	if x != nil {
		return x.DesiredRevision
	}
	return 0
...
func (x *ServiceCondition) GetAppliedRevision() int64 {
	if x != nil {
...
const file_agent_proto_rawDesc = "" +
	...
	"\tnot_after\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\bnotAfter\"\xdc\x01\n" +
	...
	"allowedIps\x12@\n" +
	"\x1cpersistent_keepalive_seconds\x18\x06 \x01(\x05R\x1apersistentKeepaliveSeconds\"\x94\x02\n" +
	...
	"\x05peers\x18\x05 \x03(\v2\x17.agent.v1.WireGuardPeerR\x05peers\"+\n" +
	...
	"\tvolume_id\x18\b \x01(\tR\bvolumeId\"\xb0\x02\n" +
	...
	"\x10applied_revision\x18\x04 \x01(\x03R\x0fappliedRevision\x12\x14\n" +
	...
	"\ahealthy\x18\b \x01(\bR\ahealthy\"\x96\x01\n" +
	...
	"\apayload2\x93\x01\n" +
	"\fAgentControl\x12;\n" +
	"\x06Enroll\x12\x17.agent.v1.EnrollRequest\x1a\x18.agent.v1.EnrollResponse\x12F\n" +
