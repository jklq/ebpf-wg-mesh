...
1.1 and 1.4 landed; see [landed.md](landed.md#11-dual-stack-workload-overlay) and [landed.md](landed.md#14-crash-evidence-in-the-console). 1.2 is parked; see [freeze.md](freeze.md#12-encrypted-versioned-secrets).
