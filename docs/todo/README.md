...
1.1, 1.4, 1.5, 1.6, 1.7, and 1.9 landed; see [landed.md](landed.md#11-dual-stack-workload-overlay), [landed.md](landed.md#14-crash-evidence-in-the-console), [landed.md](landed.md#15-truthful-time-and-status), [landed.md](landed.md#16-railpack-as-the-default-builder), [landed.md](landed.md#17-auto-deploy-onoff-per-environment), and [landed.md](landed.md#19-credentials-out-of-process-arguments). 1.2 is parked; see [freeze.md](freeze.md#12-encrypted-versioned-secrets).
