...
1.1 and 1.5 landed; see [landed.md](landed.md#11-dual-stack-workload-overlay) and [landed.md](landed.md#15-truthful-time-and-status). 1.2 is parked; see [freeze.md](freeze.md#12-encrypted-versioned-secrets).
