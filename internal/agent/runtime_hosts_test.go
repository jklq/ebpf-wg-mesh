...
func TestRenderServiceHostsFileProvidesFullAndShortInternalNames(t *testing.T) {
	...
	contents, err := renderServiceHostsFile([]*agentv1.InternalHost{
		{Hostname: "worker.mesh.internal", Ipv4: "10.20.0.20", Ipv6: "fd00:20::20"},
		{Hostname: "accurate-reflection.mesh.internal", Ipv4: "10.20.0.10", Ipv6: "fd00:20::10"},
	})
	if err != nil {
		t.Fatal(err)
	}
	...
	for _, line := range []string{
		"10.20.0.10 accurate-reflection.mesh.internal accurate-reflection",
		"fd00:20::10 accurate-reflection.mesh.internal accurate-reflection",
		"10.20.0.20 worker.mesh.internal worker",
