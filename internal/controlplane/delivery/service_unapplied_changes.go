...
func (s *persistence) loadServiceUnappliedChangesQuerier(ctx context.Context, q ServiceQueryer, serviceID string, current *platformv1.ServiceSpec, rolloutGeneration int64) ([]*platformv1.ServiceUnappliedChange, *platformv1.ServiceSpec, error) {
